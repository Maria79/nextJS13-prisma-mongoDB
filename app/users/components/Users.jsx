...
const Users = ({ onUserClick }) => {
	...
	return (
		<div className='border py-5 px-2'>
			...
			<div className='p-2 md:h-[70vh] overflow-scroll scrollbar-hide'>
				<select
					name=''
					id=''
					onChange={(e) => onUserClick(e.target.value)}
					className=' bg-slate-200/50 w-full pl-2 overflow-scroll scrollbar-hide'
				>
					{users.map((user) => (
